    ...
    <main className='min-h-screen'>
      <div className='drawer lg:drawer-open'>
        ...
        <div className='drawer-side z-20'>
          ...
          />
          <ul className='menu menu-xl border-base-300 bg-base-200 text-base-content min-h-full w-80 border-r-1'>
            <div className='px-4 py-2'>
              <div className='bg-base-200! flex flex-row items-center justify-between'>
                <Text className='opacity-50' size='2xl'>
                  Dashboard
                </Text>
                <ThemeToggle />
              </div>
            ...
            <li>
              <Link href={`/vendors/${vendorId}/messages`}>
                <MessageCircle size={18} /> Messages
              </Link>
            </li>
            <li>
              <Link href={`/vendors/${vendorId}/profile`}>
            ...
            <li>
              <Link href={`/vendors/${vendorId}/orders`}>
